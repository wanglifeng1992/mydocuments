	...
	public class RichTextBoxExtended : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.cmFontSizes.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																						...
																						this.mi48,
																						this.mi72});
			this.cmFontSizes.RightToLeft = System.Windows.Forms.RightToLeft.No;
			// 
			// mi8
			// 
			this.mi8.Index = 0;
			...
			this.cmFonts.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																					...
																					this.menuItem5,
																					this.menuItem6});
			this.cmFonts.RightToLeft = System.Windows.Forms.RightToLeft.No;
			// 
			// miArial
			// 
			...
			this.cmColors.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																					 ...
																					 this.miGreen,
																					 this.menuItem9});
			this.cmColors.RightToLeft = System.Windows.Forms.RightToLeft.No;
			// 
			// menuItem7
			// 
			this.menuItem7.Index = 0;
			this.menuItem7.Text = "[阅读标记设置]";
			// 
			// menuItem8
			// 
		...
		private void Color_Click(object sender, System.EventArgs e)
		{
			...
			ChangeFontColor(Color.FromName(mc));
