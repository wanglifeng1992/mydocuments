...
namespace FarsiLibrary.Win
{
    ...
    public class FATabStrip : BaseStyledPanel, ISupportInitialize, IDisposable
    {
        ...
        private const int DEF_GLYPH_WIDTH = 10;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawRectangle(SystemPens.Highlight , borderRc);
        ...
        private void OnDrawTabPage(Graphics g, FATabStripItem currentItem)
        {
            ...
            if (RightToLeft == RightToLeft.No)
            {
                ...
                if (currentItem == SelectedItem)
                {
                    brush = new LinearGradientBrush(buttonRect, SystemColors.ControlLightLight, SystemColors.GradientActiveCaption , LinearGradientMode.Vertical);
                }
                else
                {
                    brush = new LinearGradientBrush(buttonRect, SystemColors.ControlLightLight, SystemColors.InactiveCaptionText, LinearGradientMode.Vertical);
                }
